...
// ============================================
function paymentgateway_mtnmomo_config() {
    return [
        'name' => 'MTN MoMo (SSP)',
        'version' => '1.0',
        'currency' => 'SSP',
...
// GATEWAY VALIDATION
// ============================================
function paymentgateway_mtnmomo_validate_config() {
    global $config;
...
// ============================================
function paymentgateway_mtnmomo_show_config() {
    global $ui, $config;
...
// PAYMENT PROCESSING
// ============================================
function paymentgateway_mtnmomo_pay($gateway, $invoice, $customer) {
...
// PAYMENT CALLBACK
// ============================================
function paymentgateway_mtnmomo_callback() {
    global $momo_db;
